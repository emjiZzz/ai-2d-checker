...
date: 2026-08-07
verified-against: cache v45, baseline-v45.json (TEMPLATED — hand-aligned zones applied) and baseline-v45-detection.json (SHIPPING — zones detected; F1 0.9231 vs 0.7736). 36 mutation pairs, 0 human labels
---
